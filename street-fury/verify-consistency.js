...
// shift limb-vs-torso palette ratios more per pose and can reach ~1.15 on
// extreme frames while still being the same character; threshold 1.20
// accepts them while staying below the identity-drift floor. Portraits use
// loose = DRIFT_MAX * 2.0.
